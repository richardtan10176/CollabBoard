...
export const useSocket = ({
  ...
  useEffect(() => {
    ...
    const newSocket = io(process.env.NEXT_PUBLIC_WS_URL || 'https://localhost:3001', {
      auth: {
        token,
      },
  ...
  }, [onDocumentJoined, onTextChanged, onCursorMoved, onUserJoined, onUserLeft, onSaveComplete, onError]);
